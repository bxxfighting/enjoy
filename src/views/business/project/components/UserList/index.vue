  ...
  <div>
    <el-card>
      <div slot="header">
        ...
        <el-button
          v-permission="[url.createProjectUserUrl]"
          ...
          <el-table-column fixed="right" label="操作" width="160">
            <template slot-scope="{row}">
              ...
              <el-popconfirm title="确定删除?" @onConfirm="deleteObj(row.user.id)">
                <el-button
                  v-permission="[url.deleteProjectUserUrl]"
...
import {
  getProjectUserListApi as getObjListApi,
  deleteProjectUserApi as deleteObjApi
...
export default {
  ...
  methods: {
    ...
    deleteObj(obj_id) {
      this.loading = true
      const data = {
        project_id: parseInt(this.objId),
        user_id: obj_id
      }
